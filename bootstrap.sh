...
gcc -Wall -O2 -c src/core/json_parser.c -o test/build/json_parser.o -Iinclude
...
gcc -o bin/sigbuild test/build/cli_parser.o test/build/json_parser.o test/build/builder.o test/build/sigbuild.o test/build/main.o test/build/cJSON.o
